...
correlation <- cor(NaRV.omit(fullPlotData[,c(9,11:45)]))
...
gam11 <- bam(model3,family = poisson(link = log), data = fullPlotData,  method = 'fREML',  discrete=TRUE, nthreads=4)
...
# 4 PLOT
```{r}
visreg(gam10, xvar = "Area", ylab = "Richness" ,gg = TRUE, partial=FALSE, rug = FALSE) 
