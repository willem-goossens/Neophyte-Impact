...
correlation <- cor(NaRV.omit(fullPlotData[,c(9,11:53)]))
...
## 3.6 Final check
```{r}
gam10 <- bam(model3,family = poisson(link = log), data = fullPlotData,  method = 'fREML',  discrete=TRUE, nthreads=4)
gam11 <- bam(model3,family = quasipoisson, data = fullPlotData,  method = 'fREML',  discrete=TRUE, nthreads=4)
