...
dsquaredGam0 <- Dsquared(obs = fullPlotData$nativeSR, pred = fitted(gam0), family = "poisson")
dsquaredGam0
```
...
dsquaredGam3 <- Dsquared(obs = fullPlotData$nativeSR, pred = fitted(gam3), family = "poisson")
dsquaredGam3
...
dsquaredGam4 <- Dsquared(obs = fullPlotData$nativeSR, pred = fitted(gam4), family = "poisson")
dsquaredGam4
dsquaredGam5 <- Dsquared(obs = fullPlotData$nativeSR, pred = fitted(gam5), family = "poisson")
dsquaredGam5
dsquaredGam6 <- Dsquared(obs = fullPlotData$nativeSR, pred = fitted(gam6), family = "poisson")
dsquaredGam6
```
