...
dsquaredGam0 <- Dsquared(obs = fullPlotData$ENS1, pred = fitted(gam0), family = "gaussian")
dsquaredGam0
```
...
dsquaredGam3 <- Dsquared(obs = fullPlotData$ENS1, pred = fitted(gam3), family = "gaussian")
dsquaredGam3
...
dsquaredGam4 <- Dsquared(obs = fullPlotData$ENS1, pred = fitted(gam4), family = "gaussian")
dsquaredGam4
dsquaredGam5 <- Dsquared(obs = fullPlotData$ENS1, pred = fitted(gam5), family = "gaussian")
dsquaredGam5
dsquaredGam6 <- Dsquared(obs = fullPlotData$ENS1, pred = fitted(gam6), family = "gaussian")
dsquaredGam6
```
...
gam11 <- bam(model3,family = gaussian, data = fullPlotData,  method = 'fREML',  discrete=TRUE, nthreads=4)
...
gam15 <- bam(model5,family = gaussian, data = fullPlotData,  method = 'fREML',  discrete=TRUE, nthreads=4)
summary(gam14)
summary(gam15)
AIC(gam3,gam4,gam5,gam6,gam7,gam8,gam9,gam10,gam11,gam12, gam13,gam14,gam15)
...
## 3.6 Final check
```{r}
gam10 <- bam(model3,family = gaussian, data = fullPlotData,  method = 'fREML',  discrete=TRUE, nthreads=4)
