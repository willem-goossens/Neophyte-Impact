...
reducedEva <- eva_country_neophyte |> select(PlotObservationID, Region,name,
...
if(scaled){
  ...
  # scale data 
  fullPlotData[, c(4:12,13:14, 16:18, 20:34 )] <- 
    scale(fullPlotData[, c(4:12,13:14, 16:18, 20:34)], center=F)
}
...
plotResiduals(simulationOutput, fullPlotData$cover_rel_intra, smoothScatter=F, rank=F)
plotResiduals(simulationOutput, fullPlotData$cover_rel_extra, smoothScatter=F, rank=F)
plotResiduals(simulationOutput, fullPlotData$EIVEresN)
plotResiduals(simulationOutput, fullPlotData$EIVEresM)
plotResiduals(simulationOutput, fullPlotData$EIVEresL)
plotResiduals(simulationOutput, fullPlotData$EIVEresR)
plotResiduals(simulationOutput, fullPlotData$EIVEresT)
plotResiduals(simulationOutput, fullPlotData$DistSeverity.sqrt)
plotResiduals(simulationOutput, fullPlotData$Grazing.Pressure.sqrt)
plotResiduals(simulationOutput, fullPlotData$Soil.Disturbance.sqrt)
plotResiduals(simulationOutput, fullPlotData$Mowing.Frequency.sqrt)
plotResiduals(simulationOutput, fullPlotData$hfp)
plotResiduals(simulationOutput, fullPlotData$chelsaP)
...
if(correlation){
  ...
  # copy dataset
  fullPlotData3 <-fullPlotData
  
  fullPlotData <-fullPlotData[!duplicated(fullPlotData[, c(13,14)]),]
}

fullPlotData$pos <- numFactor(fullPlotData$Longitude, fullPlotData$Latitude)
# run model
MDL <- glmmTMB(ENS0 ~ EIVEresN+ hfp+ cover_rel_intra + cover_rel_extra+ EIVEresM+ EIVEresR+ EIVEresL+ EIVEresT+ 
                ...
                chelsaP+ Longitude*Latitude+ (1| Dataset), data=fullPlotData3, family= poisson(link=log))
summary(MDL)
...
# this can only be done if reduced dataset
#testSpatialAutocorrelation(simulationOutput = simulationOutput, x= fullPlotData3$Longitude, y= fullPlotData3$Latitude)
```
