...
# classify in types
plot_data_intra$type <- c(1,2,3,3,2,2,4,4,4,4,4,2,1,1)
...
# classify in types
plot_data_extra$type <- c(1,2,3,3,2,2,4,4,4,4,4,2,1,1)
...
# create vector for variables
variables = data.frame(var = c("EIVEresT","EIVEresN","EIVEresM","EIVEresR","EIVEresL","DistSeverity.sqrt","Soil.Disturbance.sqrt",                               "Grazing.Pressure.sqrt","Mowing.Frequency.sqrt", "hfp","DI_extra", "DI_intra", "Area","chelsaP","elev","Longitude","Latitude"),
