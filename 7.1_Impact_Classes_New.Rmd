...
rm(list=c("fullPlot2","eva_country_neophyte"))
...
plotsPerSpecies<-foreach(i= 1:nrow(uniqueSpecies), .combine='rbind', .packages=c("dplyr","mgcv")) %dopar% {
  ...
  if(!native_intra_analysis){
  plotsPerSpecies <- read_csv("speciesDominance_new_categorization_50_cover_all_layer_cleaned.csv", show_col_types = FALSE)
