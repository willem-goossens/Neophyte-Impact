...
```{r}
fullPlotData<- subset(header, select= c(PlotObservationID, Country,Longitude, Latitude, Region, Dataset))
...
# 7 is number of vascular plants
for(i in 7:dim(fullPlotDataNas)[2]) {
...
boxplot(fullPlotData$MowingFrequency.sqrt)
...
boxplot(fullPlotData$MowingFrequency)
...
summary(fullPlotData$logDistFrequency)
